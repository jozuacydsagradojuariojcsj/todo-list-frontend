...
const LoginPage = () => {
  return (
    <>
      <div className="flex flex-col bg-nt-white justify-start items-center h-screen w-screen overflow-y-auto border border-black py-4 px-1 gap-5 
      sm:flex-row-reverse sm:px-4">
        ...
        <div className="flex flex-col flex-1 w-11/12 gap-4 sm:mx-2 md:mx-4 lg:mx-8">
            ...
            <div className="flex flex-row justify-center items-center gap-1">
              <div className="flex items-center justify-center font-noto text-sm">Don't you have an account? </div>
