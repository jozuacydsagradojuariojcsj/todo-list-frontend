...
const NavBar = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-row items-center justify-evenly position-sticky px-3 min-h-[48px] min-w-[50px] md:min-h-screen xl:min-w-[220px] 2xl:min-w-[315px] md:flex-col md:items-start md:justify-start md:gap-y-0 md:py-20">
